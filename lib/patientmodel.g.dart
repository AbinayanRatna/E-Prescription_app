...
class MedicineGlobalListAdapter extends TypeAdapter<MedicineGlobalList> {
  @override
  final int typeId = 2;

  @override
  MedicineGlobalList read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return MedicineGlobalList(
      medicineName: fields[0] as String,
      brandName: fields[1] as String,
      dosage: fields[2] as String,
      frequency: fields[3] as String,
  ...
  @override
  void write(BinaryWriter writer, MedicineGlobalList obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.medicineName)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is MedicineGlobalListAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
